...
namespace ui {
  ...
  public:
    ...
    void setDocumentStore(const SILICON::project::DocumentStore* documents) noexcept;
    [[nodiscard]] const SILICON::project::DocumentStore* documentStore() const noexcept;
